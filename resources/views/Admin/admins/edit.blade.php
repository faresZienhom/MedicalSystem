    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card card-info">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form method="post" action="{{ route('admin.dashboard.admins.update', $user) }}">
                    @csrf
                    @method('put')
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ old('name') ?? $user->name }}"
                                id="name" name="name" placeholder="Enter Admin name ...">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ old('phone') ?? $user->phone }}"
                                id="phone" name="phone" placeholder="Enter Admin phone ...">
                            @error('phone')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
